...
<div class="toTop">
    ...
    <div class="formContainer">
        ...
        <form class="frmCrd" action="<?php echo $_SERVER['PHP_SELF'];?> " method="post">
                ...
                <input class="name" type="text" name="name" id="name" value="<?php echo isset($_POST['name'])? $name : ''; ?>"/><br>
                <label  for="email">Email:</label>
                <input class="email" type="text" name="email" id="email" value="<?php echo isset($_POST['email'])? $email : ''; ?>"/><br>
                <label for="comments">Comments:</label><br>
                <textarea class="comments" name="comments" id="comments" cols="30" rows="10" maxlength="50" placeholder="Briefly list your conditions:">
